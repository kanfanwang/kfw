...
$muchoConfig = array(
    // 基本设置
    'logo' => '看番网',    // LOGO 设置：若为空则显示图片（后台上传即可），不为空则显示文字
    
    'theme' => 'colorful',    // 默认主题设置：www.lxh5068.com
    
    'islider' => '1',    // 首页今日推荐： 1 为滑动显示 0为排列显示 默认滑动·
    
    'islast' => '1',    // 首页最新更新（带排行榜）： 1 为开启 0为关闭 默认关闭·
    ...
    'islazy' => '1',    // 图片懒加载： 1 为开启 0为关闭 默认关闭·
    
    'isload' => '0',    // Load加载动画： 1 为开启 0为关闭 默认开启·
    ...
    'gonggao' => array(
        ...
        'info' => array(
            ...
            array(
                'msg' => '看番网唯一网址 kfw.ink',//网站公告短信息，最长17个字（带标点符号）
                'url' => './'  //网站公告指向链接
    ...
    'dataoke' => array(
        ...
        'siteurl' => '', // 大淘客站点域名，没有的百度大淘客安装
        
        'siteuid' => '', // (打开你的大淘客网站，随便点击一个商品，如地址：http://shop.lxh5068.com/index.php?r=l/d&id=16557894&u=651170，u=后边的即为你的uid)
    ),
    // 版权和赞赏弹窗设置
    'dialogs' => array(
        array(
